...
namespace Filters
{
    public class ModelComparer<T> : IEqualityComparer<T> where T : class
    {
        ...
        public bool Equals(T x, T y)
        {
            ...
            foreach (var item in PropertyInfoList)
            {
                ...
                if ((aX.First() as Conditions).Compare && (aY.First() as Conditions).Compare)
                {                    
        ...
        public int GetHashCode(T obj)
        {
            ...
            foreach (var item in PropertyInfoList)
            {
                ...
                if ((aX.First() as Conditions).Compare)
                {
